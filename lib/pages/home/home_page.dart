                                ...
                                child: Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Icon(Icons.location_on_outlined, size: 25,                                                color: Color.fromARGB(255, 145, 145, 145),
),
                                          Text('Inglaterra',
                                              style: TextStyle(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Icon(Icons.calendar_month, size: 25,                                                color: Color.fromARGB(255, 145, 145, 145),
),
                                          Text('29/02/2023',
                                              style: TextStyle(
                                                color: Color.fromARGB(255, 145, 145, 145),
