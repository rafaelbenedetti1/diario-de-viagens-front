...
class CommomClient {
  ...
  static Future<http.Response> postForm(String url, Map data,
      ...
      Map? customHeader}) async {
    var connectivityResult = await (Connectivity().checkConnectivity());
    if (ConnectivityResult.none == connectivityResult) {
      throw const AppException(AppException.levelWarning,
          "É necessário conexão com a internet para continuar");
    }
    var headers = {'Content-Type': 'application/x-www-form-urlencoded'};
    // TODO: Validar se esse cast não vai dar erro
    if (customHeader != null) {
      headers.addAll(customHeader as Map<String, String>);
    }
    http.Response response = await http
    ...
    switch (statusCode) {
      ...
      case 404:
        throw const AppException(
            AppException.levelWarning, "Serviço está fora do ar.",
            codeError: "erro_404");
      case 401:
        throw const AppException(AppException.levelWarning,
            "O app não está mais logado, faça o login novamente.",
            codeError: "erro_401");
      default:
        throw AppException(AppException.levelWarning,
            "Erro $statusCode ao processar a requisição.");
    }
  }
}
